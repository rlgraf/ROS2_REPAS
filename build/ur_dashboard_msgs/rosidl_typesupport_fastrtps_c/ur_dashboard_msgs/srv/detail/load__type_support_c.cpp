...
bool cdr_serialize_ur_dashboard_msgs__srv__Load_Request(
  const ur_dashboard_msgs__srv__Load_Request * ros_message,
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ur_dashboard_msgs
bool cdr_deserialize_ur_dashboard_msgs__srv__Load_Request(
  eprosima::fastcdr::Cdr & cdr,
  ur_dashboard_msgs__srv__Load_Request * ros_message)
{
  // Field name: filename
  {
    std::string tmp;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ur_dashboard_msgs
bool cdr_serialize_key_ur_dashboard_msgs__srv__Load_Request(
  const ur_dashboard_msgs__srv__Load_Request * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: filename
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ur_dashboard_msgs
size_t get_serialized_size_key_ur_dashboard_msgs__srv__Load_Request(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Load_Request__ros_msg_type * ros_message = static_cast<const _Load_Request__ros_msg_type *>(untyped_ros_message);
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ur_dashboard_msgs
size_t max_serialized_size_key_ur_dashboard_msgs__srv__Load_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const ur_dashboard_msgs__srv__Load_Request * ros_message = static_cast<const ur_dashboard_msgs__srv__Load_Request *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_ur_dashboard_msgs__srv__Load_Request(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  ur_dashboard_msgs__srv__Load_Request * ros_message = static_cast<ur_dashboard_msgs__srv__Load_Request *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_ur_dashboard_msgs__srv__Load_Request(cdr, ros_message);
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ur_dashboard_msgs
bool cdr_serialize_ur_dashboard_msgs__srv__Load_Response(
  const ur_dashboard_msgs__srv__Load_Response * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: answer
  {
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ur_dashboard_msgs
bool cdr_deserialize_ur_dashboard_msgs__srv__Load_Response(
  eprosima::fastcdr::Cdr & cdr,
  ur_dashboard_msgs__srv__Load_Response * ros_message)
{
  // Field name: answer
  {
    std::string tmp;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ur_dashboard_msgs
bool cdr_serialize_key_ur_dashboard_msgs__srv__Load_Response(
  const ur_dashboard_msgs__srv__Load_Response * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: answer
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ur_dashboard_msgs
size_t get_serialized_size_key_ur_dashboard_msgs__srv__Load_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Load_Response__ros_msg_type * ros_message = static_cast<const _Load_Response__ros_msg_type *>(untyped_ros_message);
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ur_dashboard_msgs
size_t max_serialized_size_key_ur_dashboard_msgs__srv__Load_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const ur_dashboard_msgs__srv__Load_Response * ros_message = static_cast<const ur_dashboard_msgs__srv__Load_Response *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_ur_dashboard_msgs__srv__Load_Response(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  ur_dashboard_msgs__srv__Load_Response * ros_message = static_cast<ur_dashboard_msgs__srv__Load_Response *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_ur_dashboard_msgs__srv__Load_Response(cdr, ros_message);
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ur_dashboard_msgs
bool cdr_serialize_ur_dashboard_msgs__srv__Load_Event(
  const ur_dashboard_msgs__srv__Load_Event * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: info
  {
  ...
  // Field name: request
  {
    ...
    for (size_t i = 0; i < size; ++i) {
      cdr_serialize_ur_dashboard_msgs__srv__Load_Request(
        &array_ptr[i], cdr);
    }
  }
  ...
  // Field name: response
  {
    ...
    cdr << static_cast<uint32_t>(size);
    for (size_t i = 0; i < size; ++i) {
      cdr_serialize_ur_dashboard_msgs__srv__Load_Response(
        &array_ptr[i], cdr);
    }
  }
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ur_dashboard_msgs
bool cdr_deserialize_ur_dashboard_msgs__srv__Load_Event(
  eprosima::fastcdr::Cdr & cdr,
  ur_dashboard_msgs__srv__Load_Event * ros_message)
{
  // Field name: info
  {
  ...
  // Field name: request
  {
    ...
    auto array_ptr = ros_message->request.data;
    for (size_t i = 0; i < size; ++i) {
      cdr_deserialize_ur_dashboard_msgs__srv__Load_Request(cdr, &array_ptr[i]);
    }
  }
  ...
  // Field name: response
  {
    ...
    auto array_ptr = ros_message->response.data;
    for (size_t i = 0; i < size; ++i) {
      cdr_deserialize_ur_dashboard_msgs__srv__Load_Response(cdr, &array_ptr[i]);
    }
  }
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ur_dashboard_msgs
bool cdr_serialize_key_ur_dashboard_msgs__srv__Load_Event(
  const ur_dashboard_msgs__srv__Load_Event * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: info
  ...
  // Field name: request
  {
    ...
    cdr << static_cast<uint32_t>(size);
    for (size_t i = 0; i < size; ++i) {
      cdr_serialize_key_ur_dashboard_msgs__srv__Load_Request(
        &array_ptr[i], cdr);
    }
  }
  ...
  // Field name: response
  {
    ...
    cdr << static_cast<uint32_t>(size);
    for (size_t i = 0; i < size; ++i) {
      cdr_serialize_key_ur_dashboard_msgs__srv__Load_Response(
        &array_ptr[i], cdr);
    }
  }
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ur_dashboard_msgs
size_t get_serialized_size_key_ur_dashboard_msgs__srv__Load_Event(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Load_Event__ros_msg_type * ros_message = static_cast<const _Load_Event__ros_msg_type *>(untyped_ros_message);
  ...
  // Field name: request
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_key_ur_dashboard_msgs__srv__Load_Request(
        &array_ptr[index], current_alignment);
    }
  }
  ...
  // Field name: response
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_key_ur_dashboard_msgs__srv__Load_Response(
        &array_ptr[index], current_alignment);
    }
  }
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ur_dashboard_msgs
size_t max_serialized_size_key_ur_dashboard_msgs__srv__Load_Event(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // Field name: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_key_ur_dashboard_msgs__srv__Load_Request(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Field name: response
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_key_ur_dashboard_msgs__srv__Load_Response(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const ur_dashboard_msgs__srv__Load_Event * ros_message = static_cast<const ur_dashboard_msgs__srv__Load_Event *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_ur_dashboard_msgs__srv__Load_Event(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  ur_dashboard_msgs__srv__Load_Event * ros_message = static_cast<ur_dashboard_msgs__srv__Load_Event *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_ur_dashboard_msgs__srv__Load_Event(cdr, ros_message);
}
