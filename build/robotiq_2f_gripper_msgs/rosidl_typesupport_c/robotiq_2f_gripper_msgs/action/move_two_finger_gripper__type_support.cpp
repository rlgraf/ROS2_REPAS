...
static const _MoveTwoFingerGripper_SendGoal_Event_type_support_symbol_names_t _MoveTwoFingerGripper_SendGoal_Event_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, robotiq_2f_gripper_msgs, action, MoveTwoFingerGripper_SendGoal_Event)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, robotiq_2f_gripper_msgs, action, MoveTwoFingerGripper_SendGoal_Event)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, robotiq_2f_gripper_msgs, action, MoveTwoFingerGripper_SendGoal_Event)() {
  return &::robotiq_2f_gripper_msgs::action::rosidl_typesupport_c::MoveTwoFingerGripper_SendGoal_Event_message_type_support_handle;
}
...
static const rosidl_service_type_support_t MoveTwoFingerGripper_SendGoal_service_type_support_handle = {
  ...
  &MoveTwoFingerGripper_SendGoal_Request_message_type_support_handle,
  &MoveTwoFingerGripper_SendGoal_Response_message_type_support_handle,
  &MoveTwoFingerGripper_SendGoal_Event_message_type_support_handle,
...
static const _MoveTwoFingerGripper_GetResult_Event_type_support_symbol_names_t _MoveTwoFingerGripper_GetResult_Event_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, robotiq_2f_gripper_msgs, action, MoveTwoFingerGripper_GetResult_Event)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, robotiq_2f_gripper_msgs, action, MoveTwoFingerGripper_GetResult_Event)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, robotiq_2f_gripper_msgs, action, MoveTwoFingerGripper_GetResult_Event)() {
  return &::robotiq_2f_gripper_msgs::action::rosidl_typesupport_c::MoveTwoFingerGripper_GetResult_Event_message_type_support_handle;
}
...
static const rosidl_service_type_support_t MoveTwoFingerGripper_GetResult_service_type_support_handle = {
  ...
  rosidl_typesupport_c__get_service_typesupport_handle_function,
  &MoveTwoFingerGripper_GetResult_Request_message_type_support_handle,
  &MoveTwoFingerGripper_GetResult_Response_message_type_support_handle,
  &MoveTwoFingerGripper_GetResult_Event_message_type_support_handle,
  ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_CREATE_EVENT_MESSAGE_SYMBOL_NAME(
    rosidl_typesupport_c,
    robotiq_2f_gripper_msgs,
    action,
