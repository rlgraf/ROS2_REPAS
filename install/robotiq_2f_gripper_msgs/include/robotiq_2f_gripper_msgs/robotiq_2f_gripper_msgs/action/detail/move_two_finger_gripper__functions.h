...
// IWYU pragma: private, include "robotiq_2f_gripper_msgs/action/move_two_finger_gripper.h"
 ...
 * )) before or use
 * robotiq_2f_gripper_msgs__action__MoveTwoFingerGripper_SendGoal_Event__create()
 * to allocate and initialize the message.
 * \return true if initialization was successful, otherwise false
 */
ROSIDL_GENERATOR_C_PUBLIC_robotiq_2f_gripper_msgs
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * robotiq_2f_gripper_msgs__action__MoveTwoFingerGripper_SendGoal_Event__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_robotiq_2f_gripper_msgs
...
/**
 * It calls
 * robotiq_2f_gripper_msgs__action__MoveTwoFingerGripper_SendGoal_Event__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_robotiq_2f_gripper_msgs
...
/**
 * It allocates the memory for the array and calls
 * robotiq_2f_gripper_msgs__action__MoveTwoFingerGripper_SendGoal_Event__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_robotiq_2f_gripper_msgs
...
/**
 * It calls
 * robotiq_2f_gripper_msgs__action__MoveTwoFingerGripper_SendGoal_Event__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
 ...
 * )) before or use
 * robotiq_2f_gripper_msgs__action__MoveTwoFingerGripper_GetResult_Event__create()
 * to allocate and initialize the message.
 * \return true if initialization was successful, otherwise false
 */
ROSIDL_GENERATOR_C_PUBLIC_robotiq_2f_gripper_msgs
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * robotiq_2f_gripper_msgs__action__MoveTwoFingerGripper_GetResult_Event__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_robotiq_2f_gripper_msgs
...
/**
 * It calls
 * robotiq_2f_gripper_msgs__action__MoveTwoFingerGripper_GetResult_Event__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_robotiq_2f_gripper_msgs
...
/**
 * It allocates the memory for the array and calls
 * robotiq_2f_gripper_msgs__action__MoveTwoFingerGripper_GetResult_Event__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_robotiq_2f_gripper_msgs
...
/**
 * It calls
 * robotiq_2f_gripper_msgs__action__MoveTwoFingerGripper_GetResult_Event__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
